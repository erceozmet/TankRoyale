...
let client_state = new ClientState_js_1.ClientState(SCREEN_DIMS, MAP_DIMS, MAP_VIEW_RATIO);
let MINIMAP_DIMS = { width: minimap.clientWidth, height: minimap.clientHeight };
let minimap_state = new ClientState_js_1.ClientState(MINIMAP_DIMS, MAP_DIMS, { width: 1, height: 1 });
let player_count = 0;
